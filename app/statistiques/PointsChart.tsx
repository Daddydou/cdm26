...
export type ChartUser  = { id: string; username: string }
export type ChartPoint = { match: number; label: string; nations: string; [key: string]: string | number }
...
function CustomTooltip({ active, payload }: {
  active?: boolean
  payload?: Array<{ dataKey: string; name: string; value: number; color: string; payload: ChartPoint }>
}) {
